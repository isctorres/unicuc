            ...
            <form action="controllers/ctr_contactos.php?opc=3&id=<?php echo $_GET['id']?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="sltPais" id="sltPais" class="form-control">
                        ...
                        <option value="Brasíl">Brasíl</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="txtTelefono" id="txtTelefono" class="form-control" placeholder="Ingrese su teléfono">
                </div>

                <div class="form-group">
                    <label for="rdbGenero">Género</label>
